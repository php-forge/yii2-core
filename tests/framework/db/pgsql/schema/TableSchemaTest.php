...
final class TableSchemaTest extends \yiiunit\TestCase
{
    ...
    public function testAutoIncrement(): void
    {
        ...
        $this->assertSame(
            'T_autoincrement_id_seq',
            $this->db->getQuoter()->unquoteSimpleColumnName($tableSchema->sequenceName['id'])
        );
    ...
    public function testAutoIncrementWithPrimaryKey(): void
    {
        ...
        $this->assertSame(
            'T_autoincrement_with_pk_id_seq',
            $this->db->getQuoter()->unquoteSimpleColumnName($tableSchema->sequenceName['id'])
        );
    ...
    public function testAutoIncrementWithPrimaryKeyComposite(): void
    {
        ...
        $this->assertSame(
            'T_autoincrement_with_pk_composite_id1_seq',
            $this->db->getQuoter()->unquoteSimpleColumnName($tableSchema->sequenceName['id1'])
        );
        $this->assertSame(
            'T_autoincrement_with_pk_composite_id2_seq',
            $this->db->getQuoter()->unquoteSimpleColumnName($tableSchema->sequenceName['id2'])
        );
