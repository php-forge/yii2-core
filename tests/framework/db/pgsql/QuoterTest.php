...
final class QuoterTest extends AbstractQuoter
{
    ...
    {
        return PgsqlConnection::getConnection($fixture);
    }

    /**
     * @dataProvider \yiiunit\framework\db\pgsql\provider\QuoterProvider::ensureColumnName
     */
    ...
    /**
     * @dataProvider \yiiunit\framework\db\pgsql\provider\QuoterProvider::tableNameParts
     */
    ...
    /**
     * @dataProvider \yiiunit\framework\db\pgsql\provider\QuoterProvider::columnNames
     */
    ...
    /**
     * @dataProvider \yiiunit\framework\db\pgsql\provider\QuoterProvider::simpleColumnNames
     */
    ...
    /**
     * @dataProvider \yiiunit\framework\db\pgsql\provider\QuoterProvider::columnNameWithStartingEndingCharacter
     */
    ...
    /**
     * @dataProvider \yiiunit\framework\db\pgsql\provider\QuoterProvider::tableNameWithStartingEndingCharacter
     */
    ...
    /**
     * @dataProvider \yiiunit\framework\db\pgsql\provider\QuoterProvider::simpleTableNames
     */
    ...
    /**
     * @dataProvider \yiiunit\framework\db\pgsql\provider\QuoterProvider::tableNameWithSchema
     */
    ...
    /**
     * @dataProvider \yiiunit\framework\db\pgsql\provider\QuoterProvider::stringValues
     */
