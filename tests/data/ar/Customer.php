...
class Customer extends ActiveRecord
{
    ...
    public function getOrders()
    {
        return match ($this->getDb()->driverName) {
            'oci' => $this->hasMany(Order::class, ['customer_id' => 'id'])->orderBy('[[order.id]]'),
            default => $this->hasMany(Order::class, ['customer_id' => 'id'])->orderBy('id'),
        };
    }
    ...
    {
        return $this->hasMany(Item::class, ['id' => 'item_id'])->via('orderItems2');
    }
