...
/**
 * DynamicContentAwareInterface is the interface that should be implemented by classes which support a [[View]] dynamic
 * content feature.
 */
interface DynamicContentAwareInterface
{
    /**
     * Returns a list of placeholders for dynamic content.
    ...
    /**
     * Sets a list of placeholders for dynamic content.
     * This method is used internally to implement the content caching feature.
     *
